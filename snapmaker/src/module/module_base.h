...
const uint8_t module_prio_table[][2] = {
  ...
  {/* MODULE_FUNC_TEST_SET_TEC_WORK_FLAG */       MODULE_FUNC_PRIORITY_MEDIUM, 1},
  {/* MODULE_FUNC_TEST_GET_LD_AND_CASING_TEMP */       MODULE_FUNC_PRIORITY_MEDIUM, 1},
  {/* MODULE_FUNC_TEST_SET_TEC_DEST_TEMP */       MODULE_FUNC_PRIORITY_MEDIUM, 1},
  {/* MODULE_FUNC_TEST_SET_REPORT_TEC_WORK_TIME */       MODULE_FUNC_PRIORITY_MEDIUM, 1},
};
